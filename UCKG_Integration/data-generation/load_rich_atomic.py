...
def load_data(input_file, working_dir):
    ...
    kuzu_storage = init_storage(backend="kuzu", working_dir=working_dir, namespace="graph")
    ...
    allowed_names_file = "examples/generate/generate_uckg/test_set_capec_names.txt"
    allowed_names = set()
